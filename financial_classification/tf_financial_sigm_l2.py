...
with tf.Session() as sess:  
    ...
    np.savetxt('w1_sig.txt',parameter_w1,fmt=w1_fmt,delimiter=',') 
    parameter_b1=b1.eval(session=sess)
    np.savetxt('b1_sig.txt',parameter_b1,fmt=w1_fmt,delimiter=',') 
    
    parameter_w2=w2.eval(session=sess)
    np.savetxt('w2_sig.txt',parameter_w2,fmt=w2_fmt,delimiter=',') 
    parameter_b2=b2.eval(session=sess)
    np.savetxt('b2_sig.txt',parameter_b2,fmt=w2_fmt,delimiter=',') 

    parameter_w3=w3.eval(session=sess)
    np.savetxt('w3_sig.txt',parameter_w3,fmt=w3_fmt,delimiter=',') 
    parameter_b3=b3.eval(session=sess)
    np.savetxt('b3_sig.txt',parameter_b3,fmt=w3_fmt,delimiter=',') 

    parameter_w4=w4.eval(session=sess)
    np.savetxt('w4_sig.txt',parameter_w4,fmt=w4_fmt,delimiter=',') 
    parameter_b4=b4.eval(session=sess)
    np.savetxt('b4_sig.txt',parameter_b4,fmt=w4_fmt,delimiter=',') 
