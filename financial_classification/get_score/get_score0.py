...
# -------------------------------修改参数-----------------------------------------------
log_path = os.path.join(os.path.split(os.path.realpath(__file__))[0], "log0.txt") # 日志文件记录已处理的文件名称
fin_path = os.path.join(os.path.split(os.path.realpath(__file__))[0], 'inputfile0')
fout_path = os.path.join(os.path.split(os.path.realpath(__file__))[0], 'outputfile0')
# ---------------------------------------------------------------------------------------
